...
| [nm-l2tp](https://github.com/nm-l2tp/NetworkManager-l2tp) | 1 | 1 | LPE to root | [A newline to unconfined root](https://linnemanlabs.com/posts/nm-l2tp-newline-to-unconfined-root) | [Available](/poc/nm-l2tp/) |
